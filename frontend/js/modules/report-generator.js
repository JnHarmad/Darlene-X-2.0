...
<head>
    ...
    <title>Darlene-X_2.0 Report - ${report.metadata.filename}</title>
    <style>
...
<body>
    <div class="container">
        <h1>Darlene-X_2.0 Security Analysis Report</h1>
        ...
        <div class="footer">
            <p>Report generated by Darlene-X_2.0 v2.0.0</p>
        </div>
    </div>
</body>
</html>
     ...
     */
    exportCSV(report) {
        let csv = 'Darlene-X_2.0 Analysis Report\n\n';
